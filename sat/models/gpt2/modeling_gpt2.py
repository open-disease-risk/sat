...
This GPT2 implementation accomodates for numeric scaling of tokens that have a
...
_CONFIG_FOR_DOC = "NumericGPT2Config"


class NumericGPT2Model(hf_gpt2.GPT2PreTrainedModel):
    config_class = NumericGPT2Config
    ...
    def __init__(self, config):
        ...
        self.h = nn.ModuleList(
            [
                hf_gpt2.GPT2Block(config, layer_idx=i)
