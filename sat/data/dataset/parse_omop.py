...
class omop:
    ...
    def __call__(self) -> Dataset:
        ...
        dataset_path = str(out_dir / f"{self.name}_dataset")
        ...
        materialized_ds.save_to_disk(dataset_path)
        logger.info(f"Saved processed dataset to {dataset_path}")
        
        return materialized_ds


def compute_code_statistics(source_path: str, time_field: str) -> Dict[str, Dict[str, float]]:
    """
            ...
            if value is not None:
                ...
                if scale_numerics and code in code_stats:
                    ...
                    if scale_method == "standard":
                        ...
                        numeric_value = min_scale_numerics + (float_value - min_val) / range_val
                    else:
